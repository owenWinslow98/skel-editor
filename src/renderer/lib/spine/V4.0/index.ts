	...
	// import { ManagedWebGLRenderingContext, GLTexture } from "./spine-webgl";
// export * from "./spine-core"
export * from "./spine-webgl"
...
// 	constructor (context: ManagedWebGLRenderingContext | WebGLRenderingContext, pathPrefix: string = "", downloader: IPCDownloader = new IPCDownloader()) {
